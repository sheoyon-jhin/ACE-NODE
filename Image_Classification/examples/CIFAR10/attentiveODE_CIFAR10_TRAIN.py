...
class ODEfunc(nn.Module):
    ...
    def forward(self, t, x):
        ...
        h_ = torch.mul(h_0, a_s)  # h'= h * sigma(a)
...
def get_cifar10_loaders(data_aug=False, batch_size=128, test_batch_size=1000, perc=1.0):
    ...
    train_loader = DataLoader(
        datasets.CIFAR10(root='./data', train=True, download=True, transform=transform_train), batch_size=batch_size,
...
if __name__ == '__main__':
    ...
    logger.info(model)
    logger.info('Number of parameters: {}'.format(count_parameters(model)))  ## parameters : 208138
