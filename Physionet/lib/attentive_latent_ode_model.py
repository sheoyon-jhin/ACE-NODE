...
from lib.diffeq_solver import DiffeqSolver, DiffeqSolver_Attention

from torch.distributions.normal import Normal
from lib.ode_func import ODEFunc, ODEFunc_w_Poisson, ODEFunc_Attention


def create_Attentive_LatentODE_model(
    args,
    input_dim,
    n_traj_samples,
    z0_prior,
    ...
    if args.poisson:
        ...
        gen_ode_func = ODEFunc_Attention(
            input_dim=input_dim,
    ...
    if args.z0_encoder == "odernn":
        ...
        raise Exception("Unknown encoder gor Latent ODE model: " + args.z0_encoder)
    decoder = Decoder(args.latents, gen_data_dim).to(device)
    # gen_data_dim = 1
    diffeq_solver = DiffeqSolver_Attention(
        gen_data_dim,
        gen_ode_func,
        "dopri5",
        args.latents,
