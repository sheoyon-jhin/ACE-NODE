...
from lib.diffeq_solver import DiffeqSolver_augmented
...
#####################################################################################################
## for anode
def create_Augmented_LatentODE_model(
    ...
    if args.z0_encoder == "odernn":
        ...
        z0_diffeq_solver = DiffeqSolver_augmented(
            enc_input_dim,
            rec_ode_func,
            "euler",
            args.latents,
    ...
    decoder = Decoder(args.latents + 5, gen_data_dim).to(device)

    diffeq_solver = DiffeqSolver_augmented(
        gen_data_dim,
        gen_ode_func,
        "dopri5",
        args.latents,
