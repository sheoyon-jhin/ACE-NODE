...
class LatentODE(VAE_Baseline):
    ...
    def get_reconstruction(
        ...
        if isinstance(self.encoder_z0, Encoder_z0_ODE_RNN) or isinstance(
            ...
            # first_point_mu : 1,50,10 first_point_std : 1,50,10
            means_z0 = first_point_mu.repeat(n_traj_samples, 1, 1)  # 3,50,10
            sigma_z0 = first_point_std.repeat(n_traj_samples, 1, 1)  # 3,50,10
