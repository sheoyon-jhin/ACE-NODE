...
import subprocess
import datetime
CHARACTERTRAJECTORY = ['CharacterTrajectory','CharacterTrajectory30','CharacterTrajectory50','CharacterTrajectory70'] 
SEPSIS = ['sepsisio','sepsisiono']
...
def compute_loss_all_batches(model,
	...
	if args.classif:
		...
		if args.dataset in CHARACTERTRAJECTORY :
			# import pdb ; pdb.set_trace()
			all_test_labels = all_test_labels.repeat(n_traj_samples,1,1)
