...
from lib.create_latent_ode_model import create_LatentODE_model_org
from lib.create_augmented_latent_ode_model import create_Augmented_LatentODE_model
import os
import sys
import matplotlib
...
parser.add_argument(
    "--attentive-ode", action="store_true", help="Run Latent ODE seq2seq model"
)
parser.add_argument(
    "--z0-encoder",
    type=str,
...
parser.add_argument("--n-traj-samples", type=int, default=2)
...
if __name__ == "__main__":
    ...
    if args.rnn_vae:
        ...
        model = create_LatentODE_model_org(
            args,
            input_dim,
            z0_prior,
            obsrv_std,
        ...
        model = create_Attentive_LatentODE_model(
            args,
            input_dim,
            n_traj_samples,
            z0_prior,
