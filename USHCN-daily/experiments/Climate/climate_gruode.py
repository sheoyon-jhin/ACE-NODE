...
def train_gruode(simulation_name,params_dict,device, train_idx, val_idx, test_idx, epoch_max=40):
    ...
    dl   = DataLoader(dataset=data_train, collate_fn=data_utils.custom_collate_fn, shuffle=True, batch_size=300,num_workers=1)
    ...
    np.save(f"/home/bigdyl/gru_ode_bayes/experiments/Climate/trained_models/{simulation_name}_params.npy",params_dict)
    ...
    for epoch in range(epoch_max):
        ...
        with torch.no_grad():
            ...
            if val_metric > val_metric_prev:
                ...
                print("Saving Model")
                torch.save(nnfwobj.state_dict(),f"/home/bigdyl/gru_ode_bayes/experiments/Climate/trained_models/{simulation_name}_MAX.pt")
                ...
                if epoch % 10:
                    ...
                    torch.save(nnfwobj.state_dict(),f"/home/bigdyl/gru_ode_bayes/experiments/Climate/trained_models/{simulation_name}.pt")
    ...
    print(f"Finished training GRU-ODE for Climate. Saved in /home/bigdyl/gru_ode_bayes/experiments/Climate/trained_models/{simulation_name}")
...
if __name__ =="__main__":
    ...
    simulation_name="USHCN_original_"+str(args.seed)
